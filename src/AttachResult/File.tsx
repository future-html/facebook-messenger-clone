...
// goal --> to attach the file input to the messenger and sent to the reciever
// router to the next Link router-dom
// create file attachment shown like a facebook
// show result the file sent in pattern of icon we formatted
// how to know this attachment is file
